  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white py-3xl px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-2xl">
        ...
        <div className="bg-white py-xl px-4 shadow sm:rounded-lg sm:px-xl">
            ...
            <div className="mt-xl">
              <div className="relative">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-default-gray/30" />
                </div>
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-default-gray/60">Or continue with</span>
                </div>
              </div>
            </div>
